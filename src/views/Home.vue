        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 2 aborda el uso de plataformas tecnológicas (LMS) y estrategias comunicativas en entornos virtuales de aprendizaje. Se estudian Moodle, Canvas y Google Classroom, junto con herramientas como Genially, H5P y Articulate, para crear contenidos interactivos. También se profundiza en la comunicación sincrónica y asincrónica, y en el diseño de estrategias para fomentar la participación activa y el aprendizaje colaborativo. Se promueve el desarrollo de habilidades blandas, inclusión, accesibilidad y autonomía. La unidad forma profesionales capaces de crear experiencias digitales dinámicas, éticas y centradas en el estudiante.
